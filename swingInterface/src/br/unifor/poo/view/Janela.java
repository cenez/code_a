...
import br.unifor.poo.model.Aluno;
...
public class Janela extends JFrame {
	...
	protected Tabela<Aluno> tabela = new Tabela<Aluno>();
	...
	Departamento dp = new Departamento("Computacao");
	private void addItem() {
		Aluno f = new Aluno(jTextNome.getText().toUpperCase(), "");
